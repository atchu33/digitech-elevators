        ...
        <section className="bg-slate-50 py-14 px-4 md:px-8 border-b border-slate-200">
          <div className="max-w-6xl mx-auto space-y-6">
            <div className="text-center space-y-2 mb-8">
              <h3 className="text-xs font-semibold uppercase tracking-widest text-brand-gold">Visual Showcase</h3>
              <h2 className="font-serif text-2xl md:text-3xl font-bold text-brand-navy animate-draw-line inline-block">{prod.bannerTitle} — Photo Gallery</h2>
            </div>
            ...
            <div className="grid grid-cols-4 gap-3">
              {gallery.map((img, i) => (
                <button
                  ...
                  className={`relative rounded-xl overflow-hidden group transition-all duration-300 ${i === activeImg ? 'ring-3 ring-brand-gold shadow-lg scale-[1.02]' : 'opacity-70 hover:opacity-100 hover:scale-[1.02]'}`}
                  style={{ height: '100px' }}
                >
      ...
      <section className="py-20 px-4 md:px-8 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16">
        <div className="lg:col-span-8 space-y-14">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-7 rounded-2xl border border-slate-200 shadow-sm space-y-4 animate-fade-up delay-100 card-hover">
            ...
            <div className="bg-white p-7 rounded-2xl border border-slate-200 shadow-sm space-y-4 animate-fade-up delay-200 card-hover">
              <h4 className="font-serif font-bold text-lg text-brand-navy flex items-center gap-2 border-b border-slate-200 pb-2">
          ...
          {/* Capacity + Why Choose */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-7 rounded-2xl border border-slate-200 shadow-sm space-y-4 animate-fade-up delay-300 card-hover">
              <h4 className="font-serif font-bold text-lg text-brand-navy flex items-center gap-2 border-b border-slate-200 pb-2">
            ...
            <div className="bg-white p-7 rounded-2xl border border-slate-200 shadow-sm space-y-4 animate-fade-up delay-400 card-hover">
              <h4 className="font-serif font-bold text-lg text-brand-navy flex items-center gap-2 border-b border-slate-200 pb-2">
          ...
          <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-xl space-y-6 sticky top-28">
            ...
            {formSubmitted ? (
              <div className="text-center py-10">
                <i className="fa-solid fa-circle-check text-5xl text-green-500 mb-4 animate-bounce-soft block"></i>
            ...
            <div className="bg-slate-50 rounded-xl p-4 border border-slate-200 space-y-2 text-xs text-slate-500">
              <p className="flex items-center gap-2"><i className="fa-solid fa-circle-check text-green-500 animate-pulse"></i> ISO 9001:2015 Certified</p>
              <p className="flex items-center gap-2"><i className="fa-solid fa-circle-check text-green-500 animate-pulse delay-200"></i> Govt. of Karnataka Enlisted</p>
              <p className="flex items-center gap-2"><i className="fa-solid fa-circle-check text-green-500 animate-pulse delay-400"></i> 24/7 Breakdown Support</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-gradient-to-br from-brand-navy via-slate-800 to-brand-navy text-white py-16 px-4 md:px-8 border-t-4 border-brand-gold text-center">
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="flex flex-wrap justify-center gap-4 pt-2">
            <a href="#/quote"   className="bg-brand-gold hover:bg-brand-gold-hover text-brand-navy font-bold px-7 py-3 rounded-xl text-xs uppercase tracking-widest transition shadow-lg animate-bounce-soft">Request a Free Consultation</a>
            <a href="#/quote"   className="bg-white hover:bg-slate-100 text-brand-navy font-bold px-7 py-3 rounded-xl text-xs uppercase tracking-widest transition">Get a Quote</a>
