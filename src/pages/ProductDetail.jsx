    ...
    <div className="animate-fade-in">
      ...
      <section className="relative bg-brand-navy text-white overflow-hidden border-b-4 border-brand-gold" style={{minHeight: '400px'}}>
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute left-0 right-0" style={{height:'1px', background:'linear-gradient(90deg,transparent,rgba(212,175,55,0.35),transparent)', animation:'heroSweep 4s ease-in-out infinite', top:'40%'}} />
          <div className="absolute left-0 right-0" style={{height:'1px', background:'linear-gradient(90deg,transparent,rgba(212,175,55,0.2),transparent)', animation:'heroSweep 4s ease-in-out 1.5s infinite', top:'65%'}} />
        </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-8 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-0" style={{minHeight:'400px'}}>
          ...
          <div className="flex flex-col justify-center py-8 lg:py-10 space-y-4 lg:pr-10">
            ...
            {/* Subtitle badge */}
            <div className="inline-flex items-center gap-2 bg-brand-gold/15 border border-brand-gold/30 px-4 py-2 rounded-full self-start">
              <i className="fa-solid fa-circle-check text-brand-gold text-sm" />
              <span className="text-brand-gold font-bold text-sm uppercase tracking-wider">{prod.bannerSubtitle}</span>
            </div>
            ...
            <div className="flex flex-wrap gap-3">
              <a href="#inquiry-form" className="inline-flex items-center gap-2 bg-brand-gold hover:bg-yellow-500 text-brand-navy font-bold px-6 py-3 rounded-xl text-sm uppercase tracking-wider transition-all hover:scale-105 shadow-lg">
          ...
          <div className="hidden lg:flex items-center justify-center py-6 pl-4 relative">
            <div className="relative w-full" style={{maxWidth:'420px'}}>
              ...
              <div className="absolute -top-4 left-1/2 -translate-x-1/2 z-20 flex items-center gap-2 bg-brand-navy border-2 px-4 py-2 rounded-lg shadow-xl" style={{borderColor:'rgba(212,175,55,0.5)'}}>
                <i className="fa-solid fa-elevator text-brand-gold text-sm" />
                <span className="text-brand-gold font-bold text-sm font-mono tracking-widest">▲ TOP FLOOR</span>
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4 z-20">
                  <div className="backdrop-blur-md rounded-xl p-3 flex items-center justify-between" style={{background:'rgba(255,255,255,0.08)', border:'1px solid rgba(255,255,255,0.15)'}}>
                    ...
                    <div className="w-10 h-10 rounded-xl flex items-center justify-center" style={{background:'rgba(212,175,55,0.2)', border:'1px solid rgba(212,175,55,0.4)'}}>
                      <i className={`fa-solid ${prod.icon} text-brand-gold`} />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 z-20 flex items-center gap-2 bg-brand-navy border-2 px-4 py-2 rounded-lg shadow-xl" style={{borderColor:'rgba(212,175,55,0.5)'}}>
                <i className="fa-solid fa-arrow-down text-brand-gold text-xs" />
