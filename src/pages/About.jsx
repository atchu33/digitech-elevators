    ...
    <div className="animate-fade-in">
      ...
      <section className="relative bg-brand-navy text-white py-16 px-4 text-center hero-gradient overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto space-y-4 relative z-10">
          <span className="inline-block bg-brand-gold/20 border border-brand-gold/30 text-brand-gold px-4 py-1.5 rounded-full text-xs font-semibold uppercase tracking-widest">Our Legacy</span>
          <h2 className="font-serif text-4xl md:text-5xl font-bold">About Digitech Elevators</h2>
        </div>
      </section>
      ...
      <section className="py-20 px-4 md:px-8 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
        <div className="lg:col-span-7 space-y-6">
          <h3 className="text-xs font-bold uppercase tracking-widest text-brand-gold">Company Overview</h3>
          ...
          <div className="space-y-4 text-slate-600 text-sm leading-relaxed">
            <p>
              <strong className="text-brand-navy">Company Background:</strong> Founded as a dedicated team of engineers, Digitech Elevators has evolved into an ISO 9001:2015 certified company and a Government of Karnataka Enlisted Grade-A elevator contractor. We serve thousands of properties across Karnataka.
            </p>
            <p>
        ...
        <div className="lg:col-span-5 grid grid-cols-1 gap-5">
          {[
            { icon:'fa-stamp',      title:'ISO Certified',       desc:'ISO 9001:2015 certified company, compliant with Bureau of Indian Standards (IS 14665).' },
            ...
            <div key={i} className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex gap-4 hover:shadow-md transition card-hover">
              <div className="w-12 h-12 bg-brand-gold/10 rounded-xl flex items-center justify-center text-brand-gold text-xl shrink-0">
      ...
      <section className="bg-slate-50 py-20 px-4 md:px-8 border-t border-b border-slate-200">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10">
          {[
            ...
            <div key={i} className="bg-white p-10 rounded-2xl shadow-sm border border-slate-200 space-y-5 card-hover">
              <div className="w-14 h-14 bg-brand-gold/10 rounded-2xl flex items-center justify-center text-brand-gold text-2xl">
      ...
      <section className="py-20 px-4 md:px-8 max-w-7xl mx-auto space-y-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-5 text-center">
          {[
            ...
            <div key={i} className="p-5 bg-white rounded-2xl border border-slate-200 shadow-sm space-y-3 hover:border-brand-gold hover:shadow-md transition-all card-hover">
              <i className={`fa-solid ${v.icon} text-3xl text-brand-gold`}></i>
      ...
      <section className="bg-slate-50 py-20 px-4 md:px-8 border-t border-b border-slate-200">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          <div className="lg:col-span-5 space-y-6">
            <h3 className="text-xs font-bold uppercase tracking-widest text-brand-gold">Quality Assurance</h3>
          ...
          <div className="lg:col-span-7 bg-white p-8 rounded-2xl shadow-md border border-slate-200 space-y-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs text-slate-600">
              {[
                ...
                <p key={i} className="flex items-center gap-2 bg-slate-50 p-3 rounded-lg border border-slate-100">
      ...
      <section className="py-20 px-4 md:px-8 max-w-7xl mx-auto space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            <div key={i} className="p-6 bg-white border border-slate-200 rounded-2xl hover:border-brand-gold hover:shadow-md transition-all group card-hover">
