...
const plans = [
  ...
  },
  {
    ...
    badge: null,
    color: 'from-slate-700 to-slate-800',
    description: 'Routine servicing plus coverage for minor components (switches, locks, relays).',
    includes: [
      'Monthly preventive upkeep',
      'Minor spare parts included',
      'Labor & diagnostics covered',
      'Emergency call support',
      'Major parts billed separately',
    ],
  },
  {
    icon: 'fa-star',
  ...
  },
  {
    ...
    description: 'Ultimate zero-worry package covering all parts including motors, controllers, and ARD batteries.',
    includes: [
      'Everything in Comprehensive',
      'Full motor & controller coverage',
      'ARD battery replacements',
