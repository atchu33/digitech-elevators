    ...
    <div className="animate-fade-in">
      ...
      <section className="relative bg-brand-navy text-white py-24 px-4 text-center overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto space-y-4 relative z-10">
          <span className="inline-block bg-brand-blue/20 border border-brand-blue/30 text-brand-blue px-4 py-1.5 rounded-full text-xs font-semibold uppercase tracking-widest animate-pulse-ring">Preventive Maintenance</span>
            ...
            <div className="lg:col-span-5 space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex gap-4">
                  <div className="w-10 h-10 rounded-xl bg-brand-navy text-brand-blue flex items-center justify-center shrink-0 mt-1 border border-brand-blue/20">
