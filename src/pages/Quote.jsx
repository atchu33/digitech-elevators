        ...
        <div className="lg:col-span-8 scroll-reveal-right">
          <div className="bg-white p-8 md:p-10 rounded-2xl border border-slate-200 shadow-2xl">
            <h3 className="font-serif font-bold text-2xl text-brand-navy border-b border-slate-100 pb-4 mb-6 flex items-center gap-2">
              <i className="fa-solid fa-calculator text-brand-blue animate-float"></i> Project Layout Specifications
            </h3>
            {formSubmitted ? (
              ...
              <form onSubmit={handleFormSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div>
                    ...
                    <input type="text" name="name" placeholder="Your Full Name" className="w-full border border-slate-200 rounded-lg p-3 text-xs focus:outline-none focus:border-brand-navy focus:ring-2 focus:ring-brand-blue/20 transition-all duration-200" required />
                  </div>
                  <div>
                    <label className="block text-xs font-semibold text-slate-500 mb-1.5">Company / Building Name</label>
                    <input type="text" name="company" placeholder="Company or Property Name" className="w-full border border-slate-200 rounded-lg p-3 text-xs focus:outline-none focus:border-brand-navy focus:ring-2 focus:ring-brand-blue/20 transition-all duration-200" />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div>
                    ...
                    <input type="tel" name="mobile" placeholder="Mobile Number" className="w-full border border-slate-200 rounded-lg p-3 text-xs focus:outline-none focus:border-brand-navy focus:ring-2 focus:ring-brand-blue/20 transition-all duration-200" required />
                  </div>
                  <div>
                    <label className="block text-xs font-semibold text-slate-500 mb-1.5">Email Address</label>
                    <input type="email" name="email" placeholder="Email Address" className="w-full border border-slate-200 rounded-lg p-3 text-xs focus:outline-none focus:border-brand-navy focus:ring-2 focus:ring-brand-blue/20 transition-all duration-200" />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div>
                    ...
                    <input type="text" name="city" placeholder="City" defaultValue="Bangalore" className="w-full border border-slate-200 rounded-lg p-3 text-xs focus:outline-none focus:border-brand-navy focus:ring-2 focus:ring-brand-blue/20 transition-all duration-200" required />
                  </div>
                  <div>
                    <label className="block text-xs font-semibold text-slate-500 mb-1.5">Building Type *</label>
                    <select name="buildingType" className="w-full border border-slate-200 rounded-lg p-3 text-xs text-slate-600 focus:outline-none focus:border-brand-navy focus:ring-2 focus:ring-brand-blue/20 transition-all duration-200" required>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div>
                    ...
                    <select name="elevatorType" className="w-full border border-slate-200 rounded-lg p-3 text-xs text-slate-600 focus:outline-none focus:border-brand-navy focus:ring-2 focus:ring-brand-blue/20 transition-all duration-200" required>
                  ...
                  <div>
                    ...
                    <input type="number" name="floors" min="2" max="50" placeholder="e.g. 5" className="w-full border border-slate-200 rounded-lg p-3 text-xs focus:outline-none focus:border-brand-navy focus:ring-2 focus:ring-brand-blue/20 transition-all duration-200" />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div>
                    ...
                    <select name="capacity" className="w-full border border-slate-200 rounded-lg p-3 text-xs text-slate-600 focus:outline-none focus:border-brand-navy focus:ring-2 focus:ring-brand-blue/20 transition-all duration-200">
                  ...
                  <div>
                    ...
                    <select name="service" className="w-full border border-slate-200 rounded-lg p-3 text-xs text-slate-600 focus:outline-none focus:border-brand-navy focus:ring-2 focus:ring-brand-blue/20 transition-all duration-200" required>
                ...
                <div>
                  ...
                  <textarea rows="4" name="details" placeholder="Mention shaft measurements, interior choices (Glass/SS), door style, or specific timelines if any..." className="w-full border border-slate-200 rounded-lg p-3 text-xs focus:outline-none focus:border-brand-navy focus:ring-2 focus:ring-brand-blue/20 transition-all duration-200 resize-none"></textarea>
                </div>

                <button type="submit" className="w-full bg-brand-blue hover:bg-brand-blue-dark text-white font-bold py-4 rounded-xl text-xs uppercase tracking-widest transition duration-300 shadow-lg hover:shadow-xl mt-2 flex items-center justify-center gap-2 hover:scale-[1.01] btn-glow">
                  <i className="fa-solid fa-paper-plane text-xs text-white"></i> Submit Quote Proposal Request
                </button>
              </form>
            )}
          </div>
