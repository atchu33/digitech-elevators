    ...
    <header className={`sticky top-0 z-50 bg-white transition-shadow duration-300 ${scrolled ? 'shadow-2xl' : 'shadow-md'}`}>
      ...
      <nav className="bg-white border-b border-slate-100">
        ...
        <button onClick={() => setMobileMenuOpen(!mobileMenuOpen)}
                className="lg:hidden text-brand-navy hover:text-brand-blue-bright transition focus:outline-none">
        ...
        <div className="lg:hidden bg-brand-navy text-white border-t border-slate-700 py-6 px-6 flex flex-col gap-4 text-sm font-medium max-h-[80vh] overflow-y-auto shadow-2xl animate-fade-in">
          ...
          <div className="border-b border-slate-800 pb-2">
            <button
              ...
              className="flex justify-between items-center w-full py-1 text-left hover:text-brand-blue-bright transition"
            >
              <span>Our Products</span>
              <i className={`fa-solid fa-chevron-down text-xs transition-transform duration-300 ${mobileProductsOpen ? 'rotate-180 text-brand-blue-bright' : 'text-slate-400'}`}></i>
            </button>
            {mobileProductsOpen && (
              <div className="pl-4 mt-2.5 space-y-2 border-l border-brand-blue/30 animate-slide-down">
                {[
                  ['fa-users',          'passenger',  'Passenger Lifts'],
                  ['fa-house-chimney',  'home',       'Home Lifts'],
                  ['fa-house-chimney-window', 'villa', 'Villa Lifts'],
          ...
          <div className="border-b border-slate-800 pb-2">
            ...
            >
              ...
              <i className={`fa-solid fa-chevron-down text-xs transition-transform duration-300 ${mobileServicesOpen ? 'rotate-180 text-brand-blue-bright' : 'text-slate-400'}`}></i>
            </button>
            {mobileServicesOpen && (
              <div className="pl-4 mt-2.5 space-y-2 border-l border-brand-blue/30 animate-slide-down">
                {[
